...
╚══════════════════════════════════════╝
  ...
  Coder by @Dods\n
    ...
    try:
        menu = (input(Fore.LIGHTRED_EX + " 1- Normal SMS Gönder 👻(Normal)\n\n 2- Hızlı SMS Gönder 💨(Hızlı)\n\n 3- Quit\n\n" + Fore.LIGHTBLUE_EX + " Seçim: "))
        if menu == "":
            continue
        menu = int(menu) 
    except ValueError:
    ...
    if menu == 1:
        system("cls||clear")
        print(Fore.LIGHTYELLOW_EX + "SMS Göndermek İstediğiniz Numarayı girin Sadece Türkiye(Birden çoksa 'enter' tuşuna basınız): "+ Fore.LIGHTGREEN_EX, end="")
        tel_no = input()
        tel_liste = []
        if tel_no == "":
            system("cls||clear")
        ...
        system("cls||clear")
        try:
            print(Fore.LIGHTYELLOW_EX + "Mail Sms Mail girin (Bilmiyorsanız 'enter' tuşuna basın): "+ Fore.LIGHTGREEN_EX, end="")
            mail = input()
        ...
        system("cls||clear")
        print(Fore.LIGHTRED_EX + "Çıkış yapılıyorsun...")
        break
    elif menu == 2:
        system("cls||clear")
        print(Fore.LIGHTYELLOW_EX + "SMS Göndermek İstediğiniz Numarayı girin Sadece Türkiye: "+ Fore.LIGHTGREEN_EX, end="")
        tel_no = input()
        try:
            int(tel_no)
            if len(tel_no) != 10:
